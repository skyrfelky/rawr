...
#define BAT_CALIB_REAL_VOLTAGE  4120      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
...
#define BAT_LVL5                (412 * BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // Green blink:  no beep
